...
$wp_customize->add_section( 'daily_insight_readmore_section', array(
	'title'             => esc_html__( 'Read More Options','daily-insight' ),
	'description'       => esc_html__( 'Read More Section Options.Its value changes for those section whose content type is not selected as Demo.', 'daily-insight' ),
...
$wp_customize->add_control( 'daily_insight_theme_options[readmore_text]', array(
	'label'       		=> esc_html__( 'Read More Text.', 'daily-insight' ),
