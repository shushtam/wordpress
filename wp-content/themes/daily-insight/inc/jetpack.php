 ...
 */
function daily_insight_disable_jetpack_infinite_scroll_conditionally() {
    if ( function_exists( 'is_woocommerce' ) && true === is_woocommerce() ) {
        remove_theme_support( 'infinite-scroll' );
    }
}
add_action( 'template_redirect', 'daily_insight_disable_jetpack_infinite_scroll_conditionally', 9 );